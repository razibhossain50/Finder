...
import { Eye, EyeOff, User, Lock, Sparkles, CheckCircle, Shield } from "lucide-react";
...
export default function SignupFormRegular() {
  ...
  async function onSubmit(values: SignupValues) {
    ...
    setError(null);
    try {
      await signup(values.fullName, values.username, values.password, values.confirmPassword, recaptchaToken);
    } catch (error: unknown) {
